...
#include <carla/OpenCL/OpenCLcontext2.h>

#include "RayCastLidarOCL.generated.h"

/// A ray-cast based Lidar sensor.
UCLASS()
class CARLA_API ARayCastLidarOCL : public ARayCastSemanticLidar
{
  GENERATED_BODY()
...
public:
  ...
  ARayCastLidarOCL(const FObjectInitializer &ObjectInitializer);
